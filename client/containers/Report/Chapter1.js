        ...
        <div className="px1 pt2 pb3">
          <div className="clearfix mxn1">
            ...
            <div className="clearfix">
              ...
              <div className="col sm-8 sm-offset-2 md-6 md-offset-3 lg-5 lg-offset-3 px1">
                ...
                <ul className="py05">
                  {section0.blocks[1].map((item, i) => (
                    <li key={ i } className="pl1 py05">{ item }</li>
                  ))}
                </ul>
              </div>
              ...
              <div className="col sm-8 sm-offset-2 md-7 md-offset-2 px1">
              ...
              <div className="col sm-8 sm-offset-2 md-7 md-offset-3 px1">
                <div className="clearfix mxn1">
                  ...
                  <div className="col sm-6 px1">
                    <h4 className="text-base sm-text-sm m0">{section1.blocks[4].title}</h4>
                      ...
                      <StackedBarChart
                        ...
                        labels={
                          section1.blocks[6].tabs[2].dataset.map((item, i) => {
                            return {
                              text: item.name,
                              number: numberFormatter.addCommas(Math.round(Number(item.first) + Number(item.second) + Number(item.rest)))
                            }
                          })
                        }
                        data={[
