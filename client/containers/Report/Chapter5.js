        ...
        <div className="px1 pt2 pb3">
          <div className="clearfix mxn1">
            ...
            <div className="clearfix">
              {
                /*
                 * People reached by long-term services
                 *
                 */
              }
              ...
              <div className="col sm-8 sm-offset-2 md-6 md-offset-3 lg-5 lg-offset-3 px1">
                <p className="text-xs">{section1.blocks[1].caption}</p>
              ...
              <div className="col sm-8 sm-offset-2 md-6 md-offset-3 lg-5 lg-offset-3 px1">
                ...
                <h4 className="text-base sm-text-sm m0">{section2.blocks[1].title}</h4>
                <Tabs active={0}>
                ...
                <p className="text-xs">{section2.blocks[1].caption}</p>
              </div>
