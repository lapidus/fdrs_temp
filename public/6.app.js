    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          {
            className: "clearfix bg-dark chapter-banner",
            style: {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _Tabs.TabPanel,
                { title: section1.blocks[8].tabs[0].name },
                _react2.default.createElement(
                  "div",
                  null,
                  _react2.default.createElement(_StackedBarChart2.default, {
                    ...
                    labels: section1.blocks[8].tabs[0].dataset.map(function (item, i) {
                      // return `${item.name} (${numberFormatter.addCommas(Math.round(item.first + item.second + item.rest))})`
                      return { text: item.name, number: _numberFormatter2.default.addCommas(Math.round(item.first + item.second + item.rest)) };
                    }),
                    data: [section1.blocks[8].tabs[0].dataset.map(function (item, i) {
                      return { x: item.index, y: item.first, name: item.names[0] };
                    }), section1.blocks[8].tabs[0].dataset.map(function (item, i) {
                      return { x: item.index, y: item.second, name: item.names[1] };
                    }), section1.blocks[8].tabs[0].dataset.map(function (item, i) {
                      return { x: item.index, y: item.rest };
                    })]
              ...
              _react2.default.createElement(
                _Tabs.TabPanel,
                { title: section1.blocks[8].tabs[1].name },
                _react2.default.createElement(
                  "div",
                  null,
                  _react2.default.createElement(_StackedBarChart2.default, {
                    ...
                    labels: section1.blocks[8].tabs[1].dataset.map(function (item, i) {
                      // return `${item.name} (${numberFormatter.addCommas(Math.round(item.first + item.second + item.rest))})`
                      return { text: item.name, number: _numberFormatter2.default.addCommas(Math.round(item.first + item.second + item.rest)) };
                    }),
                    data: [section1.blocks[8].tabs[1].dataset.map(function (item, i) {
                      return { x: item.index, y: item.first, name: item.names[0] };
                    }), section1.blocks[8].tabs[1].dataset.map(function (item, i) {
                      return { x: item.index, y: item.second, name: item.names[1] };
                    }), section1.blocks[8].tabs[1].dataset.map(function (item, i) {
                      return { x: item.index, y: item.rest };
                    })]
...
var _ChartTooltip = __webpack_require__(1053);
...
var _range = __webpack_require__(211);
