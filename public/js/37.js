    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.countries.map(function (country, i) {
          return country.properties.name !== "Antarctica" ? _react2.default.createElement("path", { key: i, d: (0, _d3Geo.geoPath)().projection(_this2.props.projection())(country), style: { fill: "#EFEBE9" } }) : "";
        })
      );
    }
  }]);
...
var _Countries = __webpack_require__(1191);
...
var _d3GeoProjection = __webpack_require__(276);
...
var Map = function (_React$Component) {
  ...
  function Map(props) {
    ...
    _this.state = {
      ...
      minData: min,
      maxData: max,
      scale: (0, _d.scaleLinear)().domain([min, max]).range([4, 40])
    };
    return _this;
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            !this.state.loading ? nationalSocieties.map(function (bubble, i) {

              var lat = Number(bubble.lat);
              var long = Number(bubble.long);
              var coords = long && lat ? [long, lat] : undefined;
              var bubbleData = _this2.state.currentYearData.find(function (d) {
                return d.KPI_DON_Code == bubble.KPI_DON_Code;
              });
              ...
              if (bubbleData && coords) {
                return _react2.default.createElement("circle", {
                  ...
                  r: bubbleData[_this2.props.indicator.id] ? _this2.state.scale(Number(bubbleData[_this2.props.indicator.id])) : 0,
                  style: {
                    fill: _this2.props.societiesBlacklist.indexOf(bubble.KPI_DON_Code) !== -1 || _this2.props.societiesBlacklist.length == 0 ? "rgba(208,2,27,0.8)" : "rgba(208,2,27,0.4)",
                    stroke: "#fff",
                    strokeWidth: "1.5px",
                    cursor: "pointer"
                  },
                  onMouseEnter: function onMouseEnter(e) {
                    return _this2.props.bubbleMouseEnter(e, bubble, bubbleData[_this2.props.indicator.id]);
                  },
                  onMouseLeave: function onMouseLeave() {
                    return _this2.props.bubbleMouseLeave();
                  },
                  onClick: function onClick(e) {
                    return _this2.props.bubbleClick(e, bubble, bubbleData[_this2.props.indicator.id]);
                  }
                });
              }
            }) : null
...
var _Map = __webpack_require__(1192);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_Map2.default, { indicator: { id: "KPI_noPeopleVolunteering" },
                  data: this.props.data,
                  groupedTimeSeries: this.props.grouping,
                  currentYear: 2015,
                  nationalSocieties: this.props.nationalSocieties,
                  societiesBlacklist: [],
                  bubbleMouseEnter: function bubbleMouseEnter(e, bubble, indicator) {
                    return _this2.props.showTooltip({
                      text: bubble.NSO_DON_name + " - " + (0, _niceNum2.default)(indicator, null, null, true)
                    }, e);
                  },
                  bubbleMouseLeave: function bubbleMouseLeave() {
                    return _this2.props.hideTooltip();
                  },
          ...
          _react2.default.createElement(
            "div",
            { className: "absolute t50 l0 col sm-3 px1" },
            _react2.default.createElement(
              "div",
              { className: "clearfix mxn1" },
              _react2.default.createElement(
                "div",
                { className: "col sm-10 sm-offset-2 md-9 md-offset-3 bg-secondary py2 px1" },
                _react2.default.createElement(
                  "h2",
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "col sm-8 sm-offset-3 px1 pt2 pb4" },
            _react2.default.createElement(
              "p",
              { className: "small" },
...
exports.default = (0, _reactI18next.translate)("overview", { wait: true })((0, _reactRedux.connect)(makeMapStateToProps, mapDispatchToProps)(OverviewMap));
